...
require_text "$wiki_root/Home.md" "v0.2.1" "wiki Home records current release"
require_text "$wiki_root/Installation-Guide.md" "git clone --branch v0.2.1" "wiki installation uses release tag"
require_text "$wiki_root/Version-History.md" "v0.2.1 - Release and Wiki Documentation" "wiki version history records v0.2.1"
