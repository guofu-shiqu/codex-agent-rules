...
require_text "$root_readme" "git clone --branch v0.2.4" "root README uses current release tag"
...
require_text "$wiki_root/Home.md" "v0.2.4" "wiki Home records current release"
require_text "$wiki_root/Home.md" "已优化 Superpowers / Skill 的触发逻辑" "wiki Home states Superpowers skill trigger optimization"
require_text "$wiki_root/Installation-Guide.md" "git clone --branch v0.2.4" "wiki installation uses release tag"
...
require_text "$wiki_root/Version-History.md" "v0.2.4 - Independent Project Parent Template" "wiki version history records v0.2.4"
